  ...
  private estates = [
    {
      ...
      image: '/assets/img/finca_cafe/Finca1Cafe.jpg',
      description: 'Tipo de Productor: cafetero',
      link: '/estate/1',
      backGroundimage: '/assets/img/finca_cafe/Finca1Cafe.jpg',
    ...
    },
    {
      id: 2,
      name: 'La Argentina',
      image: '/assets/img/finca_cafe/Finca2.jpg',
      description: 'Tipo de Productor: cafetero.',
      link: '/estate/1',
      backGroundimage: '/assets/img/finca_cafe/Finca2.jpg',
    ...
    },
    {
      id: 3,
      name: 'Buena vista',
      image: '/assets/img/finca_cafe/Finca3.jpg',
      description: 'Tipo de Productor: cafetero',
      link: '/estate/1',
    ...
    },
    {
      id: 4,
      name: ' La Vega',
      image: '/assets/img/finca_cacao/Finca1.jpg',
    ...
    },
    {
      ...
      image: '/assets/img/finca_cacao/Finca2.jpg',
      description: 'Tipo de Productor: cacaotero.',
      link: '/estate/3',
    },
    {
      id: 6,
      name: 'San Rafael',
      image: '/assets/img/finca_cacao/Finca3Cacao.jpg',
      description: 'Tipo de Productor: cacaotero.',
      link: '/estate/4',
    },
